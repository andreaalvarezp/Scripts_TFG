...
![alt text](https://github.com/andreaalvarezp/Scripts_TFG/Pipelines/pipeline_CT.png?raw=true "Procesado seguido para búsqueda de micovirus en *Plectosphaerella* y *Colletotrichum tofieldiae*](url))
